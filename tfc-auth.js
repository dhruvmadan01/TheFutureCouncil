...
(function () {
  ...
  function updateNavUI() {
    ...
    const isFellowshipPage = window.location.pathname.endsWith('fellowship.html') || window.location.pathname.includes('fellowship');
    ...
    navWrappers.forEach((wrapper) => {
      ...
      if (currentUser) {
        ...
        // Determine button based on Council Membership / Page:
        if (primaryBtn) {
